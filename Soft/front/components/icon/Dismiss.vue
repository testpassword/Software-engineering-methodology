<template>
  <svg fill="none" height="24" width="24" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
       viewBox="0 0 65.518 65.518" xml:space="preserve">
<g>
	<path d="M32.759,0C14.696,0,0,14.695,0,32.759s14.695,32.759,32.759,32.759s32.759-14.695,32.759-32.759S50.822,0,32.759,0z
		...
		C59.518,47.514,47.514,59.518,32.759,59.518z" stroke="currentColor"/>
</g>
</svg>
</template>
